...
<template>
  <Page auto-content-height>
    <template #doc>
      <DocAlert title="Redis 缓存" url="https://github.com/gzwrrr/fresh-distribution/tree/main/docs" />
      <DocAlert title="本地缓存" url="https://github.com/gzwrrr/fresh-distribution/tree/main/docs" />
    </template>
