...
<template>
  <Page auto-content-height>
    <template #doc>
      <DocAlert title="用户体系" url="https://github.com/gzwrrr/fresh-distribution/tree/main/docs" />
      <DocAlert title="三方登陆" url="https://github.com/gzwrrr/fresh-distribution/tree/main/docs" />
      <DocAlert
        title="Excel 导入导出"
        url="https://github.com/gzwrrr/fresh-distribution/tree/main/docs"
      />
    </template>
