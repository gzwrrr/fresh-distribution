 ...
 * @zh_CN 项目仓库地址
 */
export const VBEN_GITHUB_URL = 'https://github.com/gzwrrr/fresh-distribution';

/**
 * @zh_CN 项目文档地址
 */
export const VBEN_DOC_URL =
  'https://github.com/gzwrrr/fresh-distribution/tree/main/docs';
 ...
 * @zh_CN 项目首页地址
 */
export const VBEN_PREVIEW_URL = 'https://github.com/gzwrrr/fresh-distribution';
